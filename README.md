...
2 - Yapay Zeka ile Saldırı Analizi Yapar: Toplanan ağ verilerini (paket sayıları ve benzersiz IP adreslerini) 5 saniyede bir One-Class SVM yapay zeka modeline fırlatır. Model, trafiğin normal bir kullanım mı yoksa bir anomali (DDoS saldırısı, port taraması vb.) mi olduğunu analiz eder.
